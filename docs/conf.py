...
htmlhelp_basename = "fmristrokedoc"
...
latex_documents = [
    (master_doc, "fmristroke.tex", "fMRIStroke Documentation",
     author,
     "manual"),
]
...
man_pages = [
    (master_doc, "fmristroke", "fmristroke Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "fmristroke", "fMRI Stroke Documentation",
     author, "fmristroke", "One line description of project.",
     "Miscellaneous"),
]
...
intersphinx_mapping = {
    ...
    "rapidtide": ("https://github.com/bbfrederick/rapidtide", None)
}
