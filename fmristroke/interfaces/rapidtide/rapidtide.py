...
from nipype.interfaces.base import TraitedSpec, File, traits, isdefined, InputMultiObject, CommandLineInputSpec
...
class RapidTide(RapidTideCommand):
    ...
    def _format_arg(self, name, trait_spec, value):
        if name == "searchrange":
            return ("--searchrange -{value} {value}".format(value=self.inputs.searchrange))
        if name == "output_path":
